    ...
    <div className="flex min-h-screen flex-col bg-zinc-50">
      ...
      <main className="flex-1 container mx-auto px-4 md:px-6 py-12 max-w-4xl">
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-zinc-100">
          <h1 className="text-3xl md:text-4xl font-extrabold text-zinc-900 mb-6">Privacy Policy</h1>
          ...
          <div className="space-y-6 text-zinc-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-zinc-900 mb-3">3. Data Security</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-zinc-900 mb-3">4. Contact Us</h2>
