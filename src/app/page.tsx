    ...
    <div className="flex min-h-screen flex-col bg-zinc-50 dark:bg-zinc-900 transition-colors duration-300">
      <header className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex gap-6 text-sm font-medium text-zinc-600 dark:text-zinc-300">
          ...
          <Link href="#testimonials" className="hover:text-zinc-900 transition-colors">Wall of Love</Link>
        </nav>
      ...
      <main className="flex-1">
        <section className="container mx-auto px-4 md:px-6 py-24 lg:py-32 flex flex-col items-center text-center">
          ...
          <div id="features" className="mt-20 scroll-mt-24 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl text-left">
            <div className="group flex flex-col items-start p-6 bg-white dark:bg-zinc-800/80 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-700 transition-all duration-300 hover:shadow-lg hover:-tranzinc-y-1 hover:border-indigo-100 dark:hover:border-indigo-800 cursor-default">
              ...
              <p className="text-zinc-600 dark:text-zinc-300">You only pay a fraction of the revenue we successfully recover for you.</p>
            </div>
            <div className="group flex flex-col items-start p-6 bg-white dark:bg-zinc-800/80 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-700 transition-all duration-300 hover:shadow-lg hover:-tranzinc-y-1 hover:border-indigo-100 dark:hover:border-indigo-800 cursor-default">
              ...
              <p className="text-zinc-600 dark:text-zinc-300">Connect your Stripe account in seconds. We handle the rest automatically.</p>
            </div>
            <div className="group flex flex-col items-start p-6 bg-white dark:bg-zinc-800/80 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-700 transition-all duration-300 hover:shadow-lg hover:-tranzinc-y-1 hover:border-indigo-100 dark:hover:border-indigo-800 cursor-default">
              ...
              <p className="text-zinc-600 dark:text-zinc-300">Optimized retry schedules and personalized emails that your customers actually read.</p>
            </div>
          </div>
          
          <div id="pricing" className="mt-32 scroll-mt-24 w-full max-w-5xl">
            <h2 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50 mb-12">Simple, transparent pricing.</h2>
            <div className="bg-white dark:bg-zinc-800/80 p-8 rounded-3xl shadow-sm border border-zinc-100 dark:border-zinc-700 flex flex-col md:flex-row items-center justify-between mx-auto max-w-3xl">
              <div className="text-left mb-6 md:mb-0">
                <h3 className="text-2xl font-bold mb-2 text-zinc-900 dark:text-zinc-50">Performance Built</h3>
                <p className="text-zinc-600 dark:text-zinc-300">No monthly fees. We only win when you win.</p>
              </div>
              <div className="text-center md:text-right">
                <span className="text-5xl font-extrabold text-indigo-600 dark:text-indigo-400">5%</span>
                <span className="text-zinc-500 dark:text-zinc-400 font-medium ml-2">of recovered revenue</span>
              </div>
            </div>
          </div>

          <div id="testimonials" className="mt-32 scroll-mt-24 w-full max-w-5xl mb-12">
            <h2 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50 mb-12">Loved by founders.</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white dark:bg-zinc-800/80 p-8 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-700 text-left">
                ...
                <p className="text-zinc-700 dark:text-zinc-300 italic mb-6">"Retain.io essentially pays for itself. Setting it up took 2 minutes and it recovered $1,200 in our first week alone that would have completely churned out."</p>
                <div className="font-bold text-zinc-900 dark:text-zinc-50">Sarah J.</div>
                <div className="text-sm text-zinc-500 dark:text-zinc-400">Founder, SaaS Co.</div>
              </div>
              <div className="bg-white dark:bg-zinc-800/80 p-8 rounded-2xl shadow-sm border border-zinc-100 dark:border-zinc-700 text-left">
                <div className="flex text-yellow-400 dark:text-yellow-500 mb-4">★★★★★</div>
                <p className="text-zinc-700 dark:text-zinc-300 italic mb-6">"The Stripe integration is flawless. We used to do all of this manually and missed so many failed payments. The automated emails look incredibly professional."</p>
                <div className="font-bold text-zinc-900 dark:text-zinc-50">David M.</div>
                <div className="text-sm text-zinc-500 dark:text-zinc-400">CTO, Tech Startup</div>
              </div>
            </div>
          </div>
        </section>
